...
# 결과를 저장할 파일 열기
with open('model_results_and_correlations_256_512.txt', 'w') as output_file:
    for model_name in models:
        ...
        output_file.write(f"\nPearson Correlation (256-512): {correlation:.4f}\n")
        output_file.write(f"P-value: {p_value:.4f}\n")
        output_file.write("\n" + "="*50 + "\n\n")

print("Results and correlations for sequence lengths 256-512 have been saved to 'model_results_and_correlations_256_512.txt'")