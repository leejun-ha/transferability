...
def create_combined_graph_2(model_pairs, output_filename):
    ...
    common_y_count_max = 1e6
    common_y_perf_min = 0.5
    common_y_perf_max = 1.0
    ...
    plt.subplots_adjust(wspace=0.8)  # Adjust this value to increase or decrease the space
...
common_y_perf_min = 0.5    # Minimum performance value
common_y_perf_max = 1.0  # Maximum performance value
