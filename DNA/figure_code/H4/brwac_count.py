...
def analyze_tokens(dataset, tokenizer):
    ...
    for item in tqdm(dataset, desc="Processing Items"):
        for paragraph in item['text']['paragraphs']:
...
average_count, token_counts_per_sequence, token_counts_per_sequence_no_truncation, frequencies, total_tokens = analyze_tokens(sampled_dataset, tokenizer)
